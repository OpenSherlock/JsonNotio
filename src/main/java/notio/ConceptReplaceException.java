package notio;
    ...
    /** 
     * Exception thrown when the replacing of a concept gives rise to an
     * error. 
     *
...
public class ConceptReplaceException extends OperationException
  {
    /**
     ...
     */
  public ConceptReplaceException(String message)
    {
    super(message);
    }
     ...
     */
  public ConceptReplaceException(String message, Throwable newSubThrowable)
    {
